...
#define SERRS if(get_option(tern,slicer_print_debug_info)==DBG1)errs()
#define SERRS2 if(get_option(tern,slicer_print_debug_info)==DBG2)errs()
...
#define NORMAL_SLICING (get_option(tern,slicer_do_max_slicing)==0)
#define MAX_SLICING (get_option(tern,slicer_do_max_slicing)==1)
#define RANGE_SLICING (get_option(tern, slicer_do_max_slicing)==2)
