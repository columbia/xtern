...
void XTernTraceUtil::load(const char *tracePath, DynInstrVector *trace) {

}

void XTernTraceUtil::store(unsigned testCaseId, const char *outputDir, DynInstrVector *trace) {
