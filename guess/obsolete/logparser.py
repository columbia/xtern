...
HANDLED_OPNAMES = {
  ...
  'tern_idle'                     : 'IDLE',
  'tern_thread_end'               : 'END',
  'pthread_cond_signal'           : 'PC_S',
  'pthread_create'                : 'P_C',
  'pthread_join'                  : 'P_J',
  'pthread_mutex_init'            : 'M_I',
  'pthread_mutex_lock'            : 'M_L',
  'pthread_mutex_unlock'          : 'M_UL',
  'pthread_cond_wait_first'       : 'PC_W_1',
  'pthread_cond_wait_second'      : 'PC_W_2',
  'pthread_cond_broadcast'        : 'PC_BR',
  'pthread_barrier_init'          : 'B_I',
  'pthread_barrier_wait_first'    : 'B_W_1',
  'pthread_barrier_wait_second'   : 'B_W_2',
  'pthread_barrier_destroy'       : 'B_D',
  'tern_lineup_init'              : '@I@',
  'tern_lineup_start'             : '@S@',
  'tern_lineup_end'               : '@E@',
...
#   network functions
  'accept_first'                  : 'ACC_1',
  'accept_second'                 : 'ACC_2',
  'connect_first'                 : 'CONN_1',
  'connect_second'                : 'CONN_2',
  'write'                         : 'WRITE',
  'read_first'                    : 'READ_1',
  'read_second'                   : 'READ_2',
#  'recv_first'                    : 'RECV_F',
